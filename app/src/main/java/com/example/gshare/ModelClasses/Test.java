...
public class Test {
    public static void main( String [] Args){
        ...
        User user1 = new User( "Bora Cun", "brcn24", "afafa", "cuncun24@gmail.com", 100 );
        User user2 = new User( "Cagri Eren", "ejderado", "dfasfd", "ejderado99@gmail.com", 100 );
    ...
    public static void printChat( Chat chat1 , User user ){
        for(int i = 0; i < chat1.getAllMessage().size(); i++ ){
            ...
            if(chat1.getAllMessage().get(i).getSender().equals(user)) {
                ...
                System.out.println();
                System.out.printf("%40s", chat1.getAllMessage().get(i).getCurrentTime() );
            }
            else{
                System.out.println( chat1.getAllMessage().get(i) );
                System.out.println( chat1.getAllMessage().get(i).getCurrentTime() );
            }
        }
    }
}
